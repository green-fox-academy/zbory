...
void init_timer2(TimerMode mode)
{
	...
	timer2_handle.Init.Prescaler = 10800 - 1; // 0.1ms
	timer2_handle.Init.Period = 10000 - 1; // 1s
...
void init_timer3(TimerMode mode)
{
	...
	timer3_handle.Init.Period = 40000 - 1; // 1s
	timer3_handle.Init.ClockDivision = TIM_CLOCKDIVISION_DIV1;
	timer3_handle.Init.CounterMode = TIM_COUNTERMODE_DOWN;
