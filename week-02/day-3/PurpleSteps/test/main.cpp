...
//Draws purple square with black border
...
void draw() {
    ...
    for (int i = 0; i < 20; i++){
        drawSquare((SCREEN_WIDTH / size) * i +(SCREEN_WIDTH / size), (SCREEN_WIDTH / size) * i + (SCREEN_WIDTH / size), size);
    }
}

void drawSquare(int x, int y, int size) {
    SDL_Rect square = {x, y, SCREEN_WIDTH / size, SCREEN_WIDTH / size};
